...
export function GlobalLoadingRite() {
  // Считаем только ПЕРВИЧНЫЕ загрузки (у запроса ещё нет данных). Фоновые
  // рефетчи и инвалидации по WebSocket не должны накрывать экран оверлеем —
  // для них есть локальные скелетоны на самих страницах.
