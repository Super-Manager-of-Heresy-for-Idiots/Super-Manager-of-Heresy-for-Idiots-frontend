...
import { FallPanel } from '../FallPanel';
import { SurpriseReadyPanel } from '../SurpriseReadyPanel';
...
export function TurnTab({ campaignId, battle, movement, tacticalTokens, mapSessionId }: TurnTabProps) {
  ...
  return (
    <div className={s.tabPad}>
      ...
      <FallPanel campaignId={campaignId} battle={battle} />
      <SurpriseReadyPanel campaignId={campaignId} battle={battle} current={current} />
