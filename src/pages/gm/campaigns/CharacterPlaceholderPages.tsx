  ...
  return (
    <CharacterFeaturePlaceholder
      ...
      details={[
        ...
        'Для GM/admin здесь должен быть общий список персонажей кампании с владельцами, статусами, HP и быстрым переходом в управление.',
        'Нужны фильтры по статусу, владельцу и классу, а также массовые GM-действия, если они появятся в контракте.',
      ]}
    />
  );
}
  ...
  return (
    <CharacterFeaturePlaceholder
      ...
      details={[
        ...
        'Для владельца и GM нужно показать доступные поля редактирования, для остальных оставить только просмотр.',
  ...
  return (
    <CharacterFeaturePlaceholder
      ...
      details={[
        ...
        'Владелец и GM должны иметь форму изменения значения через PUT /stats/{statId}.',
  ...
  return (
    <CharacterFeaturePlaceholder
      ...
      details={[
        ...
        'Позже сюда можно добавить бросок d20, историю проверок и отправку результата GM.',
      ]}
    />
  );
}
  ...
  return (
    <CharacterFeaturePlaceholder
      ...
      details={[
        ...
        'Владелец и GM должны иметь форму начисления и списания валюты через POST /wallet.',
  ...
  return (
    <CharacterFeaturePlaceholder
      ...
      details={[
        ...
        'Владелец и GM должны менять currentValue через POST /resources.',
