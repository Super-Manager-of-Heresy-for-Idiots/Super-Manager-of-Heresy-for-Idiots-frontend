  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16, marginBottom: 24 }}>
        <div>
          ...
          <p className="ao-italic" style={{ color: 'var(--ink-quiet)', fontSize: 13, marginTop: 6 }}>
            {className} · LVL {character.totalLevel} · Owner: {character.ownerUsername}
          </p>
        </div>
      ...
      <OrdoPanel frame padding={0} style={{ marginBottom: 24 }}>
        ...
        <div style={{ padding: 16, display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) auto', gap: 12, alignItems: 'center' }}>
