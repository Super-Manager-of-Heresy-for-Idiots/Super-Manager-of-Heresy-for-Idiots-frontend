...
| Homebrew authoring | `AdminClassRichWizard.tsx`, `homebrew/RichClassWizard.tsx` | 🚧 Phase 8: сырой JSON-импорт удалён (правило 6); табовый builder на новых grant-типах ждёт authoring-контракт BE |
